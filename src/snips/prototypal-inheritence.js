...
var Animal = function (type, name, isveg) {
...
var AnimalConstructor = function (type, name, isveg) {
  this.type = type;
  this.name = name;
  this.isveg = isveg;
...
var AnimalPrototype = function () { this.iamAnimal = true; };    // An empty function
